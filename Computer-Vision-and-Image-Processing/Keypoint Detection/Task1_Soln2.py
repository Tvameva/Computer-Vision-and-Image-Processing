...
def writeImage(img, outputFileName):
	imwrite('output/Task1_Sol2_'+outputFileName+'.jpg', img)
	return 1
...
def mergeSobelXYValues(convoluted_img_sobelX, convoluted_img_sobelY):
	...
	for convoluted_img_i in np.arange( convoluted_img.shape[0] ):
		for convoluted_img_j in np.arange( convoluted_img.shape[1] ):
			convoluted_img[convoluted_img_i, convoluted_img_j] = ((255.0)*(convoluted_img[convoluted_img_i, convoluted_img_j]/maxVal))
...
def main():
	...
	writeImage(convoluted_img_gaussianKernel, 'convoluted_img_gaussianKernel')
	...
	displayImage(convoluted_img_sobelX, "convoluted_img_sobelX_SNAPSHOT")
	...
	#So i have taken a snapshot of this as it runs
	displayImage(convoluted_img_sobelY, "convoluted_img_sobelY_SNAPSHOT")
